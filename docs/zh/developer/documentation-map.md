...
| 卡牌对战网页 | `cardbattle-server/` · `cardbattle-frontend/` | [卡牌对战](../cardbattle/README.md) · [规则](../cardbattle/rules.md) · [UI 设计](../cardbattle/ui-design.md) | — | `.cursor/skills/textech-card-art/` · [奖励桥](../cardbattle/rewards-bridge.md) |
