...
**路径**: `src/main/java/com/imgood/textech/blocks/BlockGrappleAnchor.java`
...
**路径**: `src/main/java/com/imgood/textech/tileentity/TileEntityGrappleAnchor.java`
...
**路径**: `src/main/java/com/imgood/textech/items/ItemGrappleHook.java`
...
**服务端处理**: `PacketHandlers.runOnServer`（内部 `HandlerTick.enqueueServerTask`）保证主线程
...
**分类**: `grapple`（`config/textech/textech.cfg`）
