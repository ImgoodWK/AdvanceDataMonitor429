...
| Standalone Card Battle integration | `CommandCardBattle.java` · `ConfigCardBattleLoader.java` | [integration overview](../cardbattle/README.md) · [reward bridge](../cardbattle/rewards-bridge.md) | `manual/config_reference.json` | The game lives in a separate repository; ADM keeps only the private Bridge adapter |
