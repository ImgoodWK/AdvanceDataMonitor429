...
export const CARD_CATALOG: CardDef[] = [
  ...
  { id: 'van_smite', name: 'Smite', nameZh: '惩戒', theme: 'vanilla', kind: 'spell', cost: 2, textZh: '对敌方一个单位造成 3 点伤害。' },
  { id: 'van_heal', name: 'Bandage', nameZh: '绷带', theme: 'vanilla', kind: 'spell', cost: 1, textZh: '治疗己方一个单位 3 点生命。' },
  { id: 'van_rally', name: 'Rally', nameZh: '集结', theme: 'vanilla', kind: 'spell', cost: 3, textZh: '所有己方单位 +1 攻直到回合结束（简化：永久 +1）。' },
  ...
  { id: 'gt_overclock', name: 'Overclock', nameZh: '超频', theme: 'gt', kind: 'spell', cost: 1, textZh: '本回合多获得 2 费（简化：立刻 +2）。', art: 'gt_overclock.png' },
  { id: 'gt_wrench', name: 'Wrench Bash', nameZh: '扳手猛击', theme: 'gt', kind: 'spell', cost: 2, textZh: '拆除敌方一个机器结构。', art: 'gt_wrench.png' },
  ...
  { id: 'th_ordo_aer', name: 'Ordo+Aer Infusion', nameZh: '秩序·风 注魔', theme: 'thaum', kind: 'spell', cost: 2, textZh: '给单位挂 秩序+风：格挡阶段可交换己方两个槽位。', art: 'th_ordo_aer.png' },
  { id: 'th_ignis', name: 'Ignis Bolt', nameZh: '火源质弹', theme: 'thaum', kind: 'spell', cost: 2, textZh: '造成 2 点伤害并附加 ignis。', art: 'th_ignis.png' },
  { id: 'th_ward', name: 'Warding', nameZh: '护盾结界', theme: 'thaum', kind: 'spell', cost: 1, textZh: '单位 +2 甲。', art: 'th_ward.png' },
  ...
  { id: 'fo_plugin_speed', name: 'Frame Accelerator', nameZh: '加速框架', theme: 'forestry', kind: 'spell', cost: 1, textZh: '蜂箱冷却 -1。' },
  { id: 'fo_plugin_strong', name: 'Mutator', nameZh: '突变器', theme: 'forestry', kind: 'spell', cost: 2, textZh: '下一只蜂获得吸血或 AOE（随机）。' },
  ...
  { id: 'fo_smoke', name: 'Smoke Gun', nameZh: '烟雾枪', theme: 'forestry', kind: 'spell', cost: 1, textZh: '移除敌方一个隐秘。' },

  // —— Astral: cheap utility + nexus buffs ——
  { id: 'as_shield', name: 'Stellar Ward', nameZh: '星辉护盾', theme: 'astral', kind: 'spell', cost: 1, textZh: '玩家减伤 +10%（可叠）。' },
  { id: 'as_reflect', name: 'Star Reflection', nameZh: '星辉反射', theme: 'astral', kind: 'spell', cost: 2, textZh: '本局玩家受伤反弹到对方玩家。' },
  ...
  { id: 'as_attune', name: 'Attunement', nameZh: '调谐', theme: 'astral', kind: 'spell', cost: 1, textZh: '抽 1 张牌。' },
  { id: 'as_ritual', name: 'Celestial Ritual', nameZh: '天体仪式', theme: 'astral', kind: 'spell', cost: 3, textZh: '全体己方单位 +1/+1。' },
  ...
  { id: 'as_nova', name: 'Nova Burst', nameZh: '新星爆发', theme: 'astral', kind: 'spell', cost: 2, textZh: '对敌方 Nexus 造成 2 点伤害。' },
  { id: 'as_mantle', name: 'Mantle', nameZh: '星辉披风', theme: 'astral', kind: 'unit', cost: 2, attack: 2, health: 2, textZh: '实用白板。' },
  { id: 'as_lens', name: 'Lens', nameZh: '星辉透镜', theme: 'astral', kind: 'spell', cost: 0, textZh: '本回合费用 +1。' },
  ...
  { id: 'av_singularity', name: 'Singularity', nameZh: '奇点', theme: 'avaritia', kind: 'spell', cost: 4, keywords: ['singularity'], textZh: '记录奇点进度（需集齐）。' },
  { id: 'av_singularity_2', name: 'Iron Singularity', nameZh: '铁奇点', theme: 'avaritia', kind: 'spell', cost: 4, keywords: ['singularity'], textZh: '奇点进度 +1。' },
  { id: 'av_singularity_3', name: 'Gold Singularity', nameZh: '金奇点', theme: 'avaritia', kind: 'spell', cost: 5, keywords: ['singularity'], textZh: '奇点进度 +1。' },
  { id: 'av_eternal', name: 'Eternal Singularity', nameZh: '永恒奇点', theme: 'avaritia', kind: 'spell', cost: 8, keywords: ['eternal_singularity'], textZh: '需已打出 3 个奇点：激活即死斩杀链路。' },
  { id: 'av_sword', name: 'Skullfire Sword', nameZh: '骷髅之剑', theme: 'avaritia', kind: 'unit', cost: 6, attack: 6, health: 4, textZh: '成型前的朴素大单位。' },
  { id: 'av_armor', name: 'Infinity Breastplate', nameZh: '无尽胸甲', theme: 'avaritia', kind: 'spell', cost: 3, textZh: 'Nexus +5 最大生命并治疗 5。' },
  { id: 'av_catalyst', name: 'Catalyst', nameZh: '催化剂', theme: 'avaritia', kind: 'spell', cost: 2, textZh: '抽 2，弃 1（简化：抽 1）。' },
  ...
  { id: 'ee_watch', name: 'Swiftwolf Watch', nameZh: '迅狼怀表', theme: 'ee', kind: 'spell', cost: 2, keywords: ['accelerator'], textZh: '目标结构冷却 -2。' },
  { id: 'ee_trans', name: 'Transmutation', nameZh: '转化', theme: 'ee', kind: 'spell', cost: 1, textZh: '抽 1 张。' },
  ...
  { id: 'ee_klein', name: 'Klein Star', nameZh: '克莱因之星', theme: 'ee', kind: 'spell', cost: 2, textZh: '+3 费本回合。' },
  { id: 'ee_phil', name: 'Philosophers Stone', nameZh: '贤者之石', theme: 'ee', kind: 'spell', cost: 3, textZh: '复制手牌最左边一张到牌库顶（简化：抽同主题随机）。' },
  { id: 'ee_catalyst', name: 'EMC Catalyst', nameZh: 'EMC 催化', theme: 'ee', kind: 'spell', cost: 1, textZh: '治疗 Nexus 2。' },
  ...
  { id: 'ge_mutate', name: 'Mutation', nameZh: '基因突变', theme: 'genetics', kind: 'spell', cost: 1, textZh: '一个单位 +1/+1。' },
  { id: 'ge_clone', name: 'Clone', nameZh: '克隆', theme: 'genetics', kind: 'spell', cost: 2, textZh: '在空位复制一个己方单位（1/1 复制体）。' },
  { id: 'ge_swarm', name: 'Swarm Call', nameZh: '虫群召唤', theme: 'genetics', kind: 'spell', cost: 3, textZh: '召唤两个 1/1 幼体。' },
  ...
  { id: 'ge_split', name: 'Cell Split', nameZh: '细胞分裂', theme: 'genetics', kind: 'spell', cost: 2, textZh: '抽 2 张单位牌（简化：抽 2）。' },
  ...
  { id: 'ae_craft', name: 'Crafting CPU', nameZh: '合成 CPU', theme: 'ae', kind: 'spell', cost: 2, textZh: '立刻随机生成一张不在卡组内的牌。' },
  { id: 'ae_fluix', name: 'Fluix Guard', nameZh: '福鲁伊克斯卫士', theme: 'ae', kind: 'unit', cost: 3, attack: 3, health: 3, textZh: 'AE 基础单位。' },
  { id: 'ae_p2p', name: 'P2P Tunnel', nameZh: 'P2P 通道', theme: 'ae', kind: 'spell', cost: 1, textZh: '抽 1。' },
  { id: 'ae_cell', name: 'Storage Cell', nameZh: '存储元件', theme: 'ae', kind: 'spell', cost: 3, textZh: '手牌上限外额外留 1（简化：抽 2）。' },
  { id: 'ae_annihilation', name: 'Annihilation Plane', nameZh: '破坏面板', theme: 'ae', kind: 'spell', cost: 2, textZh: '对单位造成 2 伤害。' },
  { id: 'ae_formation', name: 'Formation Plane', nameZh: '成型面板', theme: 'ae', kind: 'spell', cost: 2, textZh: '召唤一个 2/2 物质球。' },
  ...
  { id: 'ae_wireless', name: 'Wireless', nameZh: '无线终端', theme: 'ae', kind: 'spell', cost: 1, textZh: '查看并拿取地区外卡池一张。' },

  // —— DLB: force swap ——
  { id: 'dlb_tantrum', name: 'Tantrum', nameZh: '巨婴发作', theme: 'dlb', kind: 'spell', cost: 2, textZh: '立刻强制攻防转换（本回合变为对方攻击）。' },
  { id: 'dlb_ignore', name: 'Rule Ignore', nameZh: '无视规则', theme: 'dlb', kind: 'spell', cost: 3, textZh: '本回合你的攻击无视格挡顺序限制一次（简化：对 Nexus 直伤 3）。' },
  ...
  { id: 'dlb_mood', name: 'Mood Swing', nameZh: '情绪摇摆', theme: 'dlb', kind: 'spell', cost: 1, textZh: '交换双方一个随机单位位置（简化：对随机敌方单位造成 1）。' },
  { id: 'dlb_nap', name: 'Nap', nameZh: '小睡', theme: 'dlb', kind: 'spell', cost: 2, textZh: '跳过敌方下个攻击声明（简化：敌方本回合 -1 费）。' },
