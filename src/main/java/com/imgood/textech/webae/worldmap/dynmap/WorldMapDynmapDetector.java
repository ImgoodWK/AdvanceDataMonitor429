 ...
 *
 * <p>
 * Detection succeeds when either the Dynmap core class is loadable <em>or</em>
 * a valid local tile root with at least one world perspective directory exists
 * (see {@link WorldMapDynmapTileRoot}).
 * </p>
 */
    ...
    public static boolean isDynmapAvailable() {
        ...
        if (cachedAvailable.booleanValue()) {
            AdvanceDataMonitor.LOG
                .info("[WebAE-WorldMap] Dynmap/GWM terrain available (class={}, tiles={})", classPresent, tilesPresent);
        } else {
