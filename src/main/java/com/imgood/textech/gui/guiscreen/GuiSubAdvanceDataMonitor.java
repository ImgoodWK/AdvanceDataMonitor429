...
public class GuiSubAdvanceDataMonitor extends ADM_GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(
            new ADM_GuiButton(
                ...
                buttonRow2Width,
                20,
                I18n.format("adm.datatype.line")) // 折线图按�?
                    .setTexture(button_texture)
                    .setHoverTexture(button_hover_texture)
        ...
        this.buttonList.add(
            new ADM_GuiButton(
                ...
                buttonRow2Width,
                20,
                I18n.format("adm.datatype.bar")) // 柱状图按�?
                    .setTexture(button_texture)
                    .setHoverTexture(button_hover_texture)
                    .setUseRGBEffect(buttonRow2RGB)
                    .setUseHoverEffect(true)
        ...
        this.buttonList.add(
            new ADM_GuiButton(
                ...
                buttonRow2Width,
                20,
                I18n.format("adm.datatype.bar3d")) // 3D柱状图按�?
                    .setTexture(button_texture)
                    .setHoverTexture(button_hover_texture)
                    .setUseRGBEffect(buttonRow2RGB)
                    .setUseHoverEffect(true)
        ...
        this.buttonList.add(
            new ADM_GuiButton(
                ...
                buttonRow2Width,
                20,
                I18n.format("adm.datatype.waterfall")) // 瀑布图按�?
                    .setTexture(button_texture)
                    .setHoverTexture(button_hover_texture)
                    .setUseRGBEffect(buttonRow2RGB)
                    .setUseHoverEffect(true)
        ...
        this.buttonList.add(
            new ADM_GuiButton(
                ...
                buttonRow2Width,
                20,
                I18n.format("adm.datatype.difference")) // 差异图按�?
                    .setTexture(button_texture)
                    .setHoverTexture(button_hover_texture)
                    .setUseRGBEffect(buttonRow2RGB)
                    .setUseHoverEffect(true)
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(
            this.fontRendererObj,
            I18n.format("adm.title.data_config", this.index + 1), // 本地化标�?
            this.offsetX + 322,
            this.offsetY - 35,
            this.textColor);
