...
public class GuiSubAEAdvanceNetworkLink extends ADM_GuiScreen {
    ...
    public void initGui() {
        ...
        buttonRowConfigYoffset1 = 20; // 重置偏移�?

        buttonRowConfigYoffset1 += buttonRowConfigYinterval1; // 跳过5�?
    ...
    protected void actionPerformed(GuiButton button) {
        ...
        switch (button.id) {
            ...
            case 16 -> {
                ...
                alphaInt += step;
                if (alphaInt > 100) alphaInt = 0; // 超过100%重置�?

                double newValue = alphaInt / 100.0; // 转回浮点�?
            ...
            case 17 -> {
                ...
                alphaInt -= step;
                if (alphaInt < 0) alphaInt = 100; // 低于0重置�?00%
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(
            this.fontRendererObj,
            I18n.format("adm.title.data_config_ae_network", this.index + 1), // 本地化标�?
            this.offsetX + 322,
            this.offsetY - 35,
            this.textColor);
