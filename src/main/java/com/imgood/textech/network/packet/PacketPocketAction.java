...
/**
 * Câ†’S action packet for the Dimensional Pocket. All actions operate on the
    ...
    private static void handleServer(EntityPlayerMP player, PacketPocketAction message) {
        ...
        switch (message.action) {
            ...
            case TOGGLE_ENABLED:
                ...
                break;
            case SET_PAGE:
                if (player.openContainer instanceof com.imgood.textech.gui.container.ContainerPocketStorage) {
                    ((com.imgood.textech.gui.container.ContainerPocketStorage) player.openContainer)
