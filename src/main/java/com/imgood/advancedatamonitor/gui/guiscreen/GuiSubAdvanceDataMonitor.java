...
public class GuiSubAdvanceDataMonitor extends ADM_GuiScreen {
    ...
    public GuiSubAdvanceDataMonitor(EntityPlayer player, World world, TileEntityAdvanceDataMonotor tileEntity,
        int index) {
        this.player = player;
        this.world = world;
    ...
    public void initGui() {
        ...
        try {
            autoTextField("Left", this.textFieldsLeft, 0, 25, this.offsetX + 70, this.offsetY + 10, 80, 20);
        ...
        try {
            autoTextField("Right", this.textFieldsRight, 0, 25, this.offsetX + 235, this.offsetY + 10, 80, 20);
        } catch (NoSuchFieldException e) {
            throw new RuntimeException(e);
        } catch (IllegalAccessException e) {
            throw new RuntimeException(e);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        autoText(label1, 0, 25, this.offsetX - 4, this.offsetY + 10, this.textColor);
        ...
        autoText(label2, 0, 25, this.offsetX + 150 - 4, this.offsetY + 10, this.textColor);
