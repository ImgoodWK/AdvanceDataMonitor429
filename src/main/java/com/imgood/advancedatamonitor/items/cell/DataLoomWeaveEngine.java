 ...
 * 
 * AE cell handlers only mirror this NBT — they never trigger weaving.
 * 
 */
...
public final class DataLoomWeaveEngine {
    ...
    public static void runScheduledPass() {
        ...
        DataLoomDebugLog.info("Weave pass started — indexed slots={}", targets.size());
    ...
    private static void processSlot(DataLoomCellSlot slotRef) {
        ...
        if (world == null) {
            ...
            DataLoomDebugLog.warn("Skip {} — world dim {} not loaded", describeSlot(slotRef), slotRef.dimensionId);
    ...
    private static void weaveItemCell(ItemStack stack, AbstractDataLoomItemCell cellItem, double intervalSeconds,
        ...
        if (marked.isEmpty()) {
            ...
            DataLoomDebugLog.warn(
                ...
                "Item weave skipped {} — no markers (nbtListSlots={})",
        ...
        if (!DataLoomCellCapacity.hasItemCapacity(state.storedTypes, state.storedCount)) {
            ...
            DataLoomDebugLog.warn(
                ...
                "Item weave skipped {} — full (types={} count={})",
        ...
        if (totalToAdd <= 0L) {
            ...
            DataLoomDebugLog.warn(
                ...
                "Item weave skipped {} — totalToAdd=0 rate={} mult={} interval={}s",
        ...
        for (int i = 0; i < markCount; i++) {
            ...
            if (cellItem instanceof ItemDataDustLoomCell && !DataLoomCellUtil.isDustItem(mark)) {
                ...
                DataLoomDebugLog.warn(
                    ...
                    "Item weave skipped marker {} — not a dust ore-dictionary item",
    ...
    private static void weaveFluidCell(ItemStack stack, AbstractDataLoomFluidCell cellItem, double intervalSeconds,
        ...
        if (markers.isEmpty()) {
            ...
            DataLoomDebugLog.warn(
                ...
                "Fluid weave skipped {} — no markers (nbtListSlots={})",
        ...
        if (!DataLoomCellCapacity.hasFluidCapacity(state.storedTypes, state.storedMb, maxTypes)) {
            ...
            DataLoomDebugLog.warn(
                ...
                "Fluid weave skipped {} — full (types={} mb={})",
        ...
        if (totalToAdd <= 0L) {
            ...
            DataLoomDebugLog.warn(
                ...
                "Fluid weave skipped {} — totalToAdd=0 rate={} mult={} interval={}s",
        ...
        for (int i = 0; i < markCount; i++) {
            ...
            if (stored == null) {
                ...
                if (!DataLoomCellCapacity.canHoldNewFluidType(state.storedTypes, state.storedMb, maxTypes)) {
                    ...
                    DataLoomDebugLog.warn(
                        ...
                        "Fluid weave {} — cannot add new type {} (types={} mb={})",
            ...
            if (typeRemaining <= 0L) {
                ...
                DataLoomDebugLog.warn(
                    ...
                    "Fluid weave {} — marker budget exhausted for {} (stored={} remaining={})",
